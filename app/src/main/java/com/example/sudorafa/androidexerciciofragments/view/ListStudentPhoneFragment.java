 ...
 */
public class ListStudentPhoneFragment extends Fragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mStudents.add(new Student("Alunos Com Telefones", "paracafa@gmail.com", "81-996006450"));
        mStudents.add(new Student("Alunos Com Telefones", "paracafa@gmail.com", "81-996006450"));
        mStudents.add(new Student("Alunos Com Telefones", "paracafa@gmail.com", "81-996006450"));
    }


    public ListStudentPhoneFragment() {
